...
t_test_script_node new_test_script_node(t_token cmd_token, t_node_type type, std::vector<t_argument> args, int argument_count, std::vector<t_redirection> redirects) {
	return (t_test_script_node){type, (t_test_cmd_node){cmd_token, args, argument_count, redirects}};
}
