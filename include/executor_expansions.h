...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   executor_expansions.h                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: kfreyer <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/30 15:42/41 by kfreyer           #+#    #+#             */
/*   Updated: 2025/01/30 15:42:41 by kfreyer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		replace_list_next_with_new_redirection(t_list *list,
				t_list *new_redirect);
...
void		*teardown_redirect(char *dir_path, char *pattern,
				t_list *dir_entries);
...
t_list		*parse_dir_entries(t_list *dir_entries, char *dir_path,
				char *pattern);
